...
public class MainActivity extends Activity implements OnItemClickListener
{
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id)
	{
		...
		{
			case 0:
				intent = new Intent(getApplicationContext(), SortingActivity.class);
				break;
			case 1:
				intent = new Intent(getApplicationContext(), FilteringActivity.class);
				break;
			case 2:
				intent = new Intent(getApplicationContext(), GroupingActivity.class);
				break;
			case 3:
				intent = new Intent(getApplicationContext(), SimpleOnDemandActivity.class);
				break;
